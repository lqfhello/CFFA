...
class BaseDataset(object):
    ...
    """
    logger = logging.getLogger("CFFA.dataset")
...
class ImageTextDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img = read_image(img_path)
        # #============================
        # aug_ss_1 = self.augmentation_ss(img)
        # aug_ss_2 = self.augmentation_ss(img)
        # # ============================
        ...
        if self.txt_aug:
            caption_tokens = self._build_random_masked_tokens_and_labels_for_txt_aug(caption_tokens.cpu().numpy())
    ...
    def _build_random_masked_tokens_and_labels_for_txt_aug(self, tokens):
